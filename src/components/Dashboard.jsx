...
const Dashboard = () => {
    ...
    async function getAllTasks(username) {
        ...
        const response = await axios.post(`${process.env.REACT_APP_BASE_URL_PROD}/users/get-all-tasks`, payload);
    ...
    async function handleSubmit(values) {
        ...
        const response = await axios.post(`${process.env.REACT_APP_BASE_URL_PROD}/users/add-task`, payload);
    ...
    async function funComplete(x) {
        ...
        const response = await axios.put(`${process.env.REACT_APP_BASE_URL_PROD}/users/updateTaskStatus`, payload)
        const temp = response.data.tasks.filter((x) => {
            return !x.isDeleted;
        });
    ...
    async function funDelete(x) {
        const payload = { email: jwtDecode(token).username, ID: x.ID }
        const response = await axios.put(`${ process.env.REACT_APP_BASE_URL_PROD }/users/deleteTask`, payload)
        const temp = response.data.tasks.filter((x) => {
            return !x.isDeleted;
        });
